...
void UMultiplayerSessionsSubsystem::FindSessioins(int MaxSearchResults)
{
	if (!SessionInterface.IsValid())
	{
		return;
...
void UMultiplayerSessionsSubsystem::DestroySession()
{
	if (GEngine)
	{
		GEngine->AddOnScreenDebugMessage(1, 5.f, FColor::Blue, FString("DestroySession......."));
	}
	if (!SessionInterface.IsValid())
	{
...
void UMultiplayerSessionsSubsystem::OnFindSessionsComplete(bool bWasSuccessful)
{
	...
	if (LastSessionSearch->SearchResults.Num()<=0)
	{
		if (GEngine)
		{
			GEngine->AddOnScreenDebugMessage(0, 2.f, FColor::Red, TEXT("LastSessionSearch->SearchResults.Num() <= 0"));
		}
